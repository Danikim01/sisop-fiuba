...
#else
	// Touch all you want.
	ENV_CREATE(user_reduce_prio_program1, ENV_TYPE_USER);
	ENV_CREATE(user_reduce_prio_program2, ENV_TYPE_USER);
	ENV_CREATE(user_reduce_prio_program3, ENV_TYPE_USER);
